...
@Mod(modid = ModInfo.MODID, version = ModInfo.VERSION, acceptableRemoteVersions = "*", guiFactory = ModInfo.GUI_FACTORY_CLASS, dependencies = "after:JEI@[3.8.1,); required-after:Forge@[12.18.1.2053,); after:AppleCore@[2.2.0,)")
